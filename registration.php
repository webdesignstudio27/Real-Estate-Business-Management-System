    ...
    if (
        ...
        // If no validation errors, proceed with database checks
            ...
            if (mysqli_num_rows($check_username) > 0) {
                ...
                $mql = "INSERT INTO users(username, type, f_name, l_name, email, phone, password, address, question, answer) 
                VALUES('" . $_POST['username'] . "', '" . $_POST['type'] . "', '" . $_POST['firstname'] . "', '" . $_POST['lastname'] . "', '" . $_POST['email'] . "', '" . $_POST['phone'] . "', '" . $_POST['password'] . "', '" . $_POST['address'] . "', '" . $_POST['question'] . "', '" . $_POST['answer'] . "')";
                mysqli_query($db, $mql);
                                ...
                                <div class="widget-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-12">
                                                <label for="exampleTextarea">Security Questions</label>
                                                <select class="form-control" name="question" id="question">
                                                    <option value="" disabled selected>Select Questions</option>
                                                    <option value="favorite_place">What's Your Favourite Place?</option>
                                                    <option value="birth_place">What's Your Birth Place?</option>
                                                </select>
                                            </div>
                                            <!-- Hidden input box initially -->
                                            <div class="form-group col-sm-12" id="answerBox" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div style="margin-top: 10px;">
                                                    <a href="login.php" style="color: #5c4ac7; font-size: 14px;">Login</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
        ...
        <script>
            document.getElementById('question').addEventListener('change', function() {
                ...
                if (questionValue) {
                    ...
                    answerBox.style.display = 'none'; // Hide the answer box
                }
            });
