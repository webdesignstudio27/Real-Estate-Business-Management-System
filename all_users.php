                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo ' <tr><td>' . $rows['username'] . '</td>
																								...
																								<td>' . $rows['date'] . '</td>
																									 ...
																									 <td><a href="delete_users.php?u_id=' . $rows['u_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_users.php?u_id=' . $rows['u_id'] . '" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
                                                }
                                            }
                                            ?>
