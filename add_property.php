                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">All Properties</h4>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            $query_res = $db->query("
                                                ...
                                                FROM 
                                                    properties
                                                JOIN 
                                                    users ON users.u_id = properties.u_id
                                                WHERE 
                                                    properties.status = 'waitinglist'
                                                ORDER BY 
                                                    properties.updated_at DESC;
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="view_property.php?property_id=<?php echo $row['property_id']; ?>" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">
                                            ...
                                            <?php
                                                ...
                                                echo '<tr><td colspan="8"><center>No Property found.</center></td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
