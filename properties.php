    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
                $query_res = mysqli_query($db, "SELECT * FROM properties WHERE status='available' ");
        ...
        <div class="food-item-wrap">
            ...
            <div class="content" style="padding: 10px;">
                <h5 style="margin-top:10px;"><a href="property.php?property_id=' . $propertyId . '">' . $r['title'] . '</a></h5>
                <div><strong>Type:</strong> ' . ucfirst($r['property_type']) . '</div>
                ...
                <div class="button-container" style="margin-top: 10px; display: flex; gap: 10px;">
                    <a href="viewdetails.php?property_id=' . $propertyId . '" class="btn btn-primary" style="flex:1;">
                        <i class="fa fa-eye"></i> View Details
                    </a>
                    <a href="javascript:void(0);" class="btn btn-warning" style="flex:1;" onclick="confirmSave(' . $propertyId . ')">
                    ...
                    // Swiper initialization for this card
                    echo '<script>
