                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">All Booked </h4>
                                </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           ...
                                           bookings.created_at AS order_date, 
                                           bookings.booking_id 
                                       FROM bookings 
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    if ($status == "" || $status == "NULL") {
                                                        echo '<td><button type="button" class="btn btn-info"><span class="fa fa-bars"></span> None</button></td>';
                                                    } elseif ($status == "processing") {
                                                        echo '<td><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"></span> Pending !</button></td>';
                                                    } elseif ($status == "confirmed") {
                                                        echo '<td><button type="button" class="btn btn-primary"><span class="fa fa-check-circle"></span> Confirmed</button></td>';
                                                    } elseif ($status == "cancelled") {
                                                        echo '<td><button type="button" class="btn btn-danger"><i class="fa fa-close"></i> Cancelled</button></td>';
                                                    }

                                                    echo '<td>' . $rows['order_date'] . '</td>';
                                                    echo '<td><a href="view_order.php?booking_id=' . $rows['booking_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-eye"></i></a></td>
         </tr>';
                                                }
                                            }
