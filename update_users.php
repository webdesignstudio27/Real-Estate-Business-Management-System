...
if (isset($_POST['submit'])) {
    if (
        ...
        if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) // Validate email address
        {
            ...
            $mql = "update users set username='$_POST[uname]',  type='$_POST[type]', f_name='$_POST[fname]', l_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',address='$_POST[address]' where u_id='$_GET[u_id]' ";
            mysqli_query($db, $mql);
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                ...
                                <div class="card-body">
                                    <?php $ssql = "select * from users where u_id='$_GET[u_id]'";
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="type" id="type">
                                                            ...
                                                            <option value="buyer" <?php if ($newrow['type'] == 'buyer') echo 'selected'; ?>>Buyer</option>
                                                            <option value="seller" <?php if ($newrow['type'] == 'seller') echo 'selected'; ?>>Seller</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row p-t-20">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="password" class="form-control" value="<?php echo password_hash($newrow['password'], PASSWORD_DEFAULT); ?>" readonly>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="address" class="form-control form-control-danger" placeholder="Enter your address"
                                                            style="width: 100%; height: 150px; resize: none;"><?php echo htmlspecialchars($newrow['address']); ?></textarea>
                                                    </div>
                                                </div>
